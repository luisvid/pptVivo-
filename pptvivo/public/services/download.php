...
try{
	...
	if(isset($_REQUEST['presentationId']) && $_REQUEST['presentationId'] != null){
		...
		$presentation = $presentationsManager->getPresentationsList(0, 1, $filters, $_SESSION ['loggedUser']->getId(), true);
	...
	elseif (isset($_REQUEST['fileToDownload']) && $_REQUEST['fileToDownload'] != null){
		
		$fileName = $_SERVER['DOCUMENT_ROOT'].'/../..'.strstr(base64_decode($_REQUEST['fileToDownload']), '/files/');
