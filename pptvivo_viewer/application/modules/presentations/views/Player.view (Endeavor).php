					...
					<div class="span12">
						<div class="row-fluid show-grid">
							<div class="span12" id="playerAds">
								#<?=str_replace(' ', '_', $presentation->getTitle())?>  <?=$presentation->getDescription()?> #Endeavor @pptvivo
							</div>
						</div>
					</div>
				</div>
							...
							<div class="row-fluid show-grid">
								...
								<div id="social-networks-share" class="span12">
									    ...
									    <script type="text/javascript"> 
											...
											function postToFeed() {
												...
												var obj = {
													...
													picture: 'http://pptvivo.com/core/img/FBEndeavor.jpg',
									...
									<div id="twitter-share-button">
										...
										<a href="https://twitter.com/share" class="twitter-share-button" data-text="#<?=str_replace(' ', '_', $presentation->getTitle())?> #Endeavor @pptvivo" data-lang="<?=$_SESSION['s_languageIso']?>">Tweet</a>
