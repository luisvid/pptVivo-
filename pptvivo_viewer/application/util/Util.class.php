...
class Util {
	 ...
	 */
	public static function getPresentationPathData($presentation, $userLogin) {
		...
		$presentationPathData['presentationsPath'] = $presentationsPathBase . $userLogin . '/' . $presentationPathData['presentationName'] . '/';
		...
		$presentationPathData['outputExtension'] = $configurator->getPresentationsOutputFormat();
		
		$presentationPathData['previewImgPath'] = '/files/' . $presentationsPathUsers . $userLogin . '/' . $presentationPathData['presentationName'] . '/' . $presentationPathData['previewFile'];
